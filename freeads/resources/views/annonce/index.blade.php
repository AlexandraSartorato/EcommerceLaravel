            ...
            <div class="panel panel-info">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                           @foreach($annonce->photos as $photo)
                                <img src="{{asset('storage/'.$photo->photographie)}}" height="120" widht="100">
                               @endforeach
                        </div>
                    <div class="col-md-7">
                        <div class="list-group">
                            @if($annonce->averageRating()<1)
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                            @elseif($annonce->averageRating()<2 ||$annonce->averageRating() == 2 )
                                <i class="fas fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                            @elseif($annonce->averageRating()>2 && $annonce->averageRating()<3  )
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                            @elseif($annonce->averageRating()>3 && $annonce->averageRating()<4 || $annonce->averageRating() == 3)
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                            @elseif($annonce->averageRating()>4 && $annonce->averageRating()<5 || $annonce->averageRating() == 4)
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="far fa-star"></i>
                            @elseif($annonce->averageRating()==5)
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                ...
                <div class="panel-footer">
                    ...
                    @if(\Auth::id() !== $annonce->user_id)
                        <a href="{{route('rate.show', $annonce->id)}}" class="btn btn-primary pull-right"><i class="fas fa-thumbs-up"></i>Rate</a>
                        @endif
                </div>
            </div>
